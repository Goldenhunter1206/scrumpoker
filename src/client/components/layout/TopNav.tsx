    ...
    <header className="h-14 bg-white border-b border-[#DFE1E6] flex items-center justify-between px-4 shrink-0">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="p-2 hover:bg-[#F4F5F7] rounded-md transition-colors lg:hidden"
        >
          <svg className="w-5 h-5 text-[#5E6C84]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex items-center gap-3">
        {countdownActive && (
          <div className="hidden md:flex items-center gap-1 px-2 py-1 text-sm font-medium text-orange-700 bg-orange-50 rounded-md border border-orange-200">
        ...
        {roomCode && (
          <div className="hidden sm:block text-xs text-[#5E6C84] bg-[#F4F5F7] px-2 py-1 rounded-md font-mono">
            {roomCode}
          </div>
        )}
        ...
        <button className="p-2 hover:bg-[#F4F5F7] rounded-md transition-colors text-[#5E6C84]" title="Settings">
